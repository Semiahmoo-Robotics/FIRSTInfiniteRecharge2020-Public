...
import frc.robot.subsystems.DialSpinner;
...
public class PositionSpin extends CommandBase {
  
  private final DialSpinner m_dialSpinner;
  private final ColorMatch m_colorMatcher;
  private Color kTarget;
  private boolean finished = false;

  public PositionSpin(DialSpinner dialSpinner) {
